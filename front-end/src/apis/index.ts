...
import getSubjectTeachersAPI from "./Server/teacher/getSubjectTeachersAPI";
import sendPrepareExamPaperMailAPI from "./Server/exam/sendPrepareExamPaperMailAPI";
...
export {
    ...
    getExamWrongBookAPI,
    getSubjectTeachersAPI,
    sendPrepareExamPaperMailAPI,
